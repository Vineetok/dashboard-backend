...
export const customerRegisterPartner = async (req, res) => {
  try {
    ...
    const customerCount = Number(customerCountResult.rows[0].count);

    const assignedRmId = rms[customerCount % rms.length].id;
    ...
    const insertQuery = `
      ...
      VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
      RETURNING id, adv_id, name, email, mobile, role, referred_by_rm;
    `;
